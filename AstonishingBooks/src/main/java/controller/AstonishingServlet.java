...
//			add( new Book("Power Rangers: Green With Evil Part 1", "The Green Ranger enters the battle", 50.00));
			...
			add( new Book("Cloud Cuckoo Land", "Anthony Doerr", date, "Fiction", 23.99, "/coverImages/cloudCuckooLand", 
			...
			add( new Book("The Picture of Dorian Gray", "Oscar Wilde", date, "Fiction", 10.00, "/coverImages/dorianGray", 
			...
			add( new Book("Dune", "Frank Herbert", date, "Fiction", 9.99, "/coverImages/dune", "Set on the desert planet "
			...
			add( new Book("The Mysterious Rider", "Zane Grey", date, "Fiction", 15.55, "/coverImages/mysteriousRider",
			...
			add( new Book("No One Wins Alone", "Mark Messier", date, "Non-Fiction", 22.99, "/coverImages/noOneWinsAlone", 
			...
			add( new Book("The Baseball 100", "Joe Pasnanski", date, "Non-Fiction", 33.99, "/coverImages/baseball100", 
			...
			add( new Book("The Code Breaker", "Walter Isaacson", date, "Non-Fiction", 27.99, "/coverImages/codeBreaker", 
			...
			add( new Book("People", "Meredith Corporation", date, "Magazine", 2.04, "/coverImages/people", "Celebrity gossip"));
			...
			add( new Book("National Geographic", "National Geographic", date, "Magazine", 1.67, "/coverImages/natGeo", 
			...
			add( new Book("TIME Magazine", "Meredith Corporation", date, "Magazine", 0.58, "/coverImages/timeMagazine", 
			...
			add( new Book("Desk Reference to the Diagnostic Criteria From DSM-5", "American Psychiatric Association", 
					date, "Reference", 74.00, "/coverImages/diagnosticCriteria", "The Desk Reference to "
			...
			add( new Book("Patent, Copyright & Trademark: An Intellectual Property Desk Reference", "Richard Stim", 
					date, "Reference", 44.99, "/coverImages/intellectualProperty", "Whether you are in the "
			...
			add( new Book("The Musical Instrument Desk Reference", "Michael J. Pagliaro", date, 
